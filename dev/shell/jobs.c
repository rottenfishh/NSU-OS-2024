...
void start_job(job* curr_job) {
    printf("job %s\n", curr_job->processes->argv.cmdargs[0]);
    ...
    if (is_interactive && tcsetattr (STDIN_FILENO, TCSANOW, &shell_modes) == -1) {
